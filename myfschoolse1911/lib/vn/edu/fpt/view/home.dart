...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      // Handle error gracefully or show snackbar
    }
  }
  ...
  Widget _buildBody() {
    switch (_currentIndex) {
      ...
      case 3:
        return ProfileScreen(phone: widget.phone);
      default:
        return _buildHomeTab();
    }
  }
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    _profile != null ? _profile!['fullName'] : (widget.phone.isNotEmpty ? 'Welcome ${widget.phone}' : 'Đang tải...'),
                  ...
                  Text(
                    _profile != null ? 'Lớp ${_profile!['className']} • Niên khóa ${_profile!['academicYear']}' : '...',
                    style: TextStyle(
                      fontSize: 12,
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: CircleAvatar(
                        ...
                        child: Text(
                          _profile != null && _profile!['fullName'] != null && _profile!['fullName'].isNotEmpty
  ...
  Widget _buildServiceGrid() {
    final services = [
      ...
      _ServiceItem(Icons.payments_rounded, 'Học phí', const Color(0xFF26A69A)),
      _ServiceItem(Icons.campaign_rounded, 'Thông báo', const Color(0xFF42A5F5)),
      _ServiceItem(Icons.people_rounded, 'Phụ huynh', const Color(0xFFAB47BC)),
      _ServiceItem(Icons.local_library_rounded, 'Thư viện', const Color(0xFF8D6E63)),
      _ServiceItem(Icons.more_horiz_rounded, 'Xem thêm', const Color(0xFF78909C)),
    ];
  ...
  Widget _buildScheduleCards() {
    final scheduleItems = [
      _ScheduleItem('Toán học', '07:30 - 08:15', 'Phòng A201', 'Thầy Nguyễn Văn B', const Color(0xFF5C6BC0)),
      _ScheduleItem('Vật lý', '08:25 - 09:10', 'Phòng B102', 'Cô Trần Thị C', const Color(0xFFEF5350)),
      _ScheduleItem('Tiếng Anh', '09:20 - 10:05', 'Phòng C305', 'Cô Lê Thị D', const Color(0xFF26A69A)),
    ];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              const Text(
                'Quản lý học tập và theo dõi tiến trình của bạn',
                style: TextStyle(
                  fontSize: 13,
                  color: TColors.textSubtitle,
                ),
              ...
              // Cards for: Schedule, Assignments, Grades
              _buildHubCard(
...
class _ScheduleItem {
  ...
  _ScheduleItem(this.subject, this.time, this.room, this.teacher, this.color);
}
